...
/**
 * Calculate refund based on days remaining before the event.
 *
 * Rules:
 * - 15+ days  → 90% refund
 * - 10+ days  → 50% refund
 ...
 * - < 7 days  → 0% refund
 *
 * A 5% processing fee is deducted from the refund amount.
 */
function calculateRefund(bookingTotal, eventDate) {
  const now = new Date();
...
module.exports = { calculateRefund, PROCESSING_FEE_RATE };
